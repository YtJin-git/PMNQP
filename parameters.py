...
parser.add_argument("--num_workers", help="number of workers", default=0, type=int)
...
parser.add_argument("--alpha_vision_ckpt_pth", help="alpha_clip path", type=str)
parser.add_argument("--dataset_path", default='E:/ZSLSampleProjects/GAN-CZSL/datasets/mit-states', help="dataset path", type=str)
...
parser.add_argument("--attr_loss_weight", help="attr_loss_weight", type=float, default=1.0)
parser.add_argument("--attr_inference_weight", help="attr_inference_weight", type=float, default=1.0)
parser.add_argument("--obj_loss_weight", help="obj_loss_weight", type=float, default=1.0)
parser.add_argument("--obj_inference_weight", help="obj_inference_weight", type=float, default=1.0)

parser.add_argument("--attr_readout_loss_weight", help="attr_readout_loss_weight", type=float, default=1.0)
